...
import pic1 from "../../assets/beauty_center/1.png";
import pic2 from "../../assets/beauty_center/2.png";
import pic3 from "../../assets/beauty_center/3.png";
import pic4 from "../../assets/beauty_center/4.png";
import pic5 from "../../assets/beauty_center/5.png";
import pic6 from "../../assets/beauty_center/6.png";
import pic7 from "../../assets/beauty_center/7.png";
import pic8 from "../../assets/beauty_center/8.png";
...
import { ReactComponent as DeviceSvg } from "../../assets/icons/DeviceSvg.svg";
import { ReactComponent as DoctorSvg } from "../../assets/icons/DoctorSvg.svg";
...
import { ReactComponent as SessionManagementSvg } from "../../assets/icons/session_management.svg";
  ...
  return (
    <div id="main" className="max-w-[1240px] mx-auto">
      <div className="flex mx-auto justify-center items-center my-5 p-5 shadow-xl">
        ...
        <BeautyCenterSvg className="w-[50px] h-[50px] flex fill-[#00df9a]" />
        <h1 className="text-white sm:text-xl md:text-3xl text-center">
          BitZone Beauty Center Management Solution
        </h1>
      </div>
      <div id="carousel">
        <Carousel autoPlay={true} infiniteLoop={true}>
          ...
          <div>
            ...
            <p className="legend">Clients Window</p>
          </div>
          <div>
            <img src={pic3} className="w-full h-auto mx-auto rounded-lg" />
            <p className="legend">Add New Session Window</p>
          </div>
          <div>
      ...
      <div id="specs" className="w-full py-6 px-4 text-white">
        ...
        <div className="max-w-[1240px] mx-auto my-2 items-start grid md:grid-cols-3">
          ...
          <div className="flex flex-col my-2 mx-2">
            <div className="flex">
              <DoctorSvg className="w-[25px] h-[25px] flex fill-[#00df9a] mx-1" />
        ...
        <div className="max-w-[1240px] mx-auto my-2 items-start grid md:grid-cols-3">
          <div className="flex flex-col my-2 mx-2">
            <div className="flex">
              <DeviceSvg className="w-[25px] h-[25px] flex fill-[#00df9a] mx-1" />
              <p className="font-semibold">Device Management:</p>
            </div>
            <ul className="list-disc indent-4">
              <li>Financial log and activity</li>
              <li>Session types</li>
          ...
          <div className="flex flex-col my-2 mx-2">
            <div className="flex">
              ...
              <p className="font-semibold">
                Session and Visit Types Management:
              </p>
            </div>
            <ul className="list-disc indent-4">
              <li>Session types</li>
          ...
          <div className="flex flex-col my-2 mx-2">
            <div className="flex">
              <SessionManagementSvg className="w-[25px] h-[25px] flex fill-[#00df9a] mx-1" />
              <p className="font-semibold">Session Management:</p>
            </div>
            <ul className="list-disc indent-4">
              <li>All sessions log</li>
              <li>Client sessions log</li>
              <li>Doctor sessions log</li>
              <li>Device sessions log</li>
            </ul>
          </div>
        </div>
        <div className="max-w-[1240px] mx-auto my-2 items-start grid md:grid-cols-3">
